                            ...
                            <div class="modal-body">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <input type="text" class="form-control" v-model="editedItem.simbolo" >
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label >equivalencia <span  class="text-danger">*</span></label>
                                        <input type="text" class="form-control" v-model="editedItem.equivalencia" >
                                    </div>
            ...
            async save () {
                ...
                try {
                    ...
                    if(this.editedItem.id === 0){
                        ...
                        var res = await axios.post(route('api.monedas.store'),data);

                    }else {

                        var res = await axios.patch(route('api.monedas.update',this.editedItem.id),data);
