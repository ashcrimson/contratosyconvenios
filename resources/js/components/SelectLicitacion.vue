<template>
    <div>
        ...
        <multiselect v-model="item" :options="items" label="numero" placeholder="Seleccione uno...">
                            ...
                            <div class="modal-body">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" class="form-control" v-model="editedItem.numero" >
                                    </div>

                                    <div class="form-group col-sm-6">
                                        <label >presupuesto <span  class="text-danger">*</span></label>
                                        <input type="number" step="any" class="form-control" v-model="editedItem.presupuesto" >
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label >descripcion <span  class="text-danger">*</span></label>
                                        <input type="text" class="form-control" v-model="editedItem.descripcion" >
                                    </div>
            ...
            async save () {
                ...
                try {
                    ...
                    if(this.editedItem.id === 0){
                        ...
                        var res = await axios.post(route('api.licitaciones.store'),data);

                    }else {

                        var res = await axios.patch(route('api.licitaciones.update',this.editedItem.id),data);
