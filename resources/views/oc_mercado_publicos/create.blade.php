...
@section('title_page',__('Nueva Orden Compra Mercado Publico'))
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{__('Nueva Orden Compra Mercado Publico')}}</h1>
                </div>
                <div class="col ">
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    {!! Form::open(['route' => 'ocMercadoPublicos.store','class' => 'wait-on-submit']) !!}
                        <div class="form-row">
