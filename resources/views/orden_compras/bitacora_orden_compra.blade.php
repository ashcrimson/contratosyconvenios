...
@section('title_page',__('Bitácora de Orden Compra'))
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{__('Bitácora de Orden Compra')}}</h1>
                </div>
                <div class="col ">
    ...
    <div class="content">
        <div class="card card-outline card-success">
            <!-- /.card-header -->
            <div class="card-body">
                @include('orden_compras.partials.show_mini_fields')
            ...
            <div class="form-group col-sm-12">
                <table class="table table-striped table-bordered table-sm">
                    ...
                    <tbody>
                    @forelse($ordenCompra->bitacoras as $bitacora)
                        <tr>
                            ...
                            <td>
                                ...
                                @can('Eliminar Bitacora Orden de Compra')
                                    ...
                                    <form action="{{ route('ordenCompras.bitacora.destroy', ['ordenCompra' => $ordenCompra->id,'bitacora' => $bitacora->id])}}" method="POST" id="delete-form{{$bitacora->id }}">
                                        @method('DELETE')
                                        @csrf
                                    </form>
                                @endcan
        ...
        <div class="card card-outline card-success">
            ...
            <div class="card-body">
                ...
                <form action="{{route('ordenCompras.bitacora.store',$ordenCompra->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
...
{{--                        </div>--}}
                        ...
                        <div class="form-group text-center col-sm-12">
                            <a  href="{{route('ordenCompras.index')}}" type="submit" class="btn btn-secondary">
                                {{__('Cancelar')}}
                            </a>
                            &nbsp;
