...
class CreateOrdenesComprasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ordenes_compras', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('contrato_id')->index('fk_ordenes_compras_contratos1_idx');
            ...
            $table->unsignedBigInteger('estado_id')->index('fk_ordenes_compras_ordenes_compras_estados1_idx');
            $table->timestamps();
            $table->softDeletes();
        });
    }
