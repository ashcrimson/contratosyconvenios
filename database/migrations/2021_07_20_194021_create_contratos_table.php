...
class CreateContratosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('contratos', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('cargo_id')->index('fk_ctr_cargos1_idx');
            $table->integer('moneda_id')->index('fk_ctr_monedas1_idx');
            $table->decimal('monto',14,0);
            $table->date('estado_alerta');
            ...
            $table->decimal('monto_boleta_garantia',14,0);
            $table->string('id_mercado_publico');
